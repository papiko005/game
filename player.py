...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,filename):
        ...
        img = pygame.image.load("img/Runman.png").convert() 
        ...
        # プレイヤーの画像を読み込む
        self. Runman_image = pygame.image.load(filename).convert()
        self. Runman_image.set_colorkey(BLACK)
...
class Animation(object):
    ...
    def update(self,fps=50):
        ...
        if self.clock in range(1,50,step):
            self.index += 1
